...
Created and maintained by **Khushi**

[![GitHub - khushikumari566](https://img.shields.io/badge/GitHub-Khushi%20Kumari-blue?logo=github)](https://github.com/khushikumari566)

**GitHub Repository:** [https://github.com/khushikumari566/portfolio-builder-app](https://github.com/khushikumari566/portfolio-builder-app)

## Overview
This is an Online Portfolio Builder that allows users to create personal portfolios using customizable templates. Enter your details, select a design, and generate a live preview or downloadable site.

## Features
- Form-based Angular UI for user input (name, skills, projects, social links)
- Multiple HTML/CSS themes with switchable color schemes
- Live preview and downloadable portfolio
- Supabase stores user data and selected themes
- One-click deployment to GitHub Pages or Netlify (optional)
...
## Tech Stack
- **Frontend:** Angular
- **Backend:** (Optional) Spring Boot or Netlify Functions
...
3. Build the project:
   ...
   npm run build --prod
   ```
4. Deploy the `dist/` folder to Netlify or your preferred static hosting.

## Database Setup
- Run the SQL in `supabase-schema.sql` in your Supabase SQL Editor to set up the database tables and sample data.
...
[![GitHub Stars](https://img.shields.io/github/stars/khushikumari566/portfolio-builder-app?style=social)](https://github.com/khushikumari566/portfolio-builder-app/stargazers)
[![GitHub Forks](https://img.shields.io/github/forks/khushikumari566/portfolio-builder-app?style=social)](https://github.com/khushikumari566/portfolio-builder-app/network/members)

[⬆️ Back to Top](#-portfolio-builder-app)

</div>
[🚀 Live Demo](https://main--portfolio-builder-app.netlify.app/) • [📖 Documentation](#-features) • [🐛 Report Bug](https://github.com/khushikumari566/portfolio-builder-app/issues) • [✨ Request Feature](https://github.com/khushikumari566/portfolio-builder-app/issues)
...
## 🌐 Links
|  **Issues & Bugs** | [https://github.com/khushikumari566/portfolio-builder-app/issues](https://github.com/khushikumari566/portfolio-builder-app/issues) |
| 📖 **Documentation** | [README.md](https://github.com/khushikumari566/portfolio-builder-app#readme) |
...
[![Deploy to Netlify](https://www.netlify.com/img/deploy/button.svg)](https://app.netlify.com/start/deploy?repository=https://github.com/khushikumari566/portfolio-builder-app)
...
```bash
# Clone the repository
git clone https://github.com/khushikumari566/portfolio-builder-app.git
cd portfolio-builder-app
...
### 🐛 Found a Bug?
1. 🔍 Check if it's already reported in [Issues](https://github.com/khushikumari566/portfolio-builder-app/issues)
2. 📝 If not, [create a new issue](https://github.com/khushikumari566/portfolio-builder-app/issues/new) with:
...
1. 💬 [Start a discussion](https://github.com/khushikumari566/portfolio-builder-app/discussions) about your idea
...
|------------|-------------|
| � **Bug Reports** | [GitHub Issues](https://github.com/khushikumari566/portfolio-builder-app/issues) |
| ❓ **Questions** | [GitHub Discussions](https://github.com/khushikumari566/portfolio-builder-app/discussions) |
| � **Feature Requests** | [GitHub Issues](https://github.com/khushikumari566/portfolio-builder-app/issues) |
| 📖 **Documentation** | [README.md](https://github.com/khushikumari566/portfolio-builder-app#readme) |
...
1. 🔍 Check [existing issues](https://github.com/khushikumari566/portfolio-builder-app/issues) first
2. 💡 [Create new feature request](https://github.com/khushikumari566/portfolio-builder-app/issues/new)
